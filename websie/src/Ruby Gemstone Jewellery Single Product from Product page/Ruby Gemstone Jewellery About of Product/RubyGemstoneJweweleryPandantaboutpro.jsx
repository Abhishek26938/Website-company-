...
const RubyGemstoneJweweleryPandantaboutpro = () => {
  return (
    <>
      <div className="Single_product-detail-div-in-info">
        <div className="single-product-div-prodcut-deatails">
          ...
          <span className="This-timeless-classic-design-p">
            This simple and elegant design showcases a natural Round Ruby in a
...
export default RubyGemstoneJweweleryPandantaboutpro;
