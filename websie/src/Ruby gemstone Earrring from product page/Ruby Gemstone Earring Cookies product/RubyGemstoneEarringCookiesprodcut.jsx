...
import {RubyEarringCookesProductData} from './RubyGemstoneEarringCookiesString'
import {Link} from 'react-router-dom'

const RubyGemstoneEarringCookiesprodcut = () => {
  return (
    <>
      ...
      <div className="div-of-auto-cookes-produt">
        {RubyEarringCookesProductData.map((item, index) => {
          return (
...
export default RubyGemstoneEarringCookiesprodcut;
