...
const RubyGemstoneEarringAboutDetails = () => {
  return (
    <>
      <div className="Single_product-detail-div-in-info">
        <div className="single-product-div-prodcut-deatails">
          ...
          <span className="This-timeless-classic-design-p">
            This simple, yet timeless solitaire design showcases natural Oval
            Cut Ruby held securely in place by four prongs in your <br /> choice
            of precious metal.{" "}
          </span>
        </div>
...
export default RubyGemstoneEarringAboutDetails;
