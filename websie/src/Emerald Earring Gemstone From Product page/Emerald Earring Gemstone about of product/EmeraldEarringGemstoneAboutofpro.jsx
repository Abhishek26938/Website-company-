...
const EmeraldEarringGemstoneAboutofpro = () => {
  return (
    <>
        ...
        <div className="single-product-div-prodcut-deatails">
          ...
          This simple, yet timeless solitaire design showcases natural Oval Cut Emerald held securely in place by four prongs in your choice <br /> of precious metal.
          </span>
        </div>
...
export default EmeraldEarringGemstoneAboutofpro
