...
import {EmeraldEarringCookesProductData} from './EmeraldEarringGemstoneCookiesString'
import {Link} from 'react-router-dom'

const EmeraldEarringGemstoneCookiesProduct = () => {
  return (
    <>
      ...
      <div className="div-of-auto-cookes-produt">
        {EmeraldEarringCookesProductData.map((item, index) => {
          return (
...
export default EmeraldEarringGemstoneCookiesProduct
