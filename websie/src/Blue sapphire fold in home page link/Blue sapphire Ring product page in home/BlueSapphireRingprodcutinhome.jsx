...
import "./BluesapphireProdcutRing.css";
import { ProductDatainRing ,productofnewData ,ProducttwoDatainBlue ,ProducteightDataBlue } from "./ProdcutPageStringpageinhome";
import { Link } from "react-router-dom";

const BlueSapphireRingprodcutinhome = () => {
...
const handleMouseEnter = (imageUrl) => {
  ...
  const handleMouseLeave = () => {
    ...
    setHoverImage('https://d3kinlcl20pxwz.cloudfront.net/image-jewelry/RBS082-AAAA/WHITEGOLD/FL.jpg');
  };
  ...
  return (
    <div className="Blue-sapphire-ring-product">
      ...
      <div className="sapphire-ring-product-div">
        <img className="image-of-prodcut-ring-page" src="https://d3kinlcl20pxwz.cloudfront.net/images/result_banner/stone.jpg" alt="" />
        ...
        {ProducttwoDatainBlue.map((item, index) => (
          <div key={index.id} className="new-div-of-shaaphire-now" >
            ...
            <Link to={item.pLInk}>
             ...
             <img className="image-of-prodcut-ring-page1" src="https://d3kinlcl20pxwz.cloudfront.net/images/result_banner/advantage.jpg" alt="" />
      </div>
...
export default BlueSapphireRingprodcutinhome;
