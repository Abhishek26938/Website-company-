...
import "./GmestoneBandsallimage.css";
import { Link } from "react-router-dom";

const Gemstonbandspageofinglepagealld = () => {
  return (
    <>
        ...
        <div className="div-of-onle-four-product-image">
          <div className="div-of-onely-singel-product">
            <div className="div-for-image-name-of-product">
              <img
                src="https://d3kinlcl20pxwz.cloudfront.net/image-jewelry/EB74110BS/WHITEGOLD/FL.jpg"
                alt=""
              />
            ...
            <div className="div-for-image-name-of-product">
              <Link
                to="https://d3kinlcl20pxwz.cloudfront.net/images/size_chart2.pdf"
                target="_blank"
              >
                <img
                  src="	https://d3kinlcl20pxwz.cloudfront.net/images/stonesizechart.jpg"
                  alt=""
                />{" "}
              </Link>
              <div className="div-of-new-product-image">
                <span className="div-of-new-product-image3">
                  Stone Size chart{" "}
                </span>
              </div>
            </div>
          </div>
          <img className="head-image-prdocut-page-image"
            src="https://d3kinlcl20pxwz.cloudfront.net/image-jewelry/EB74110BS/WHITEGOLD/FL.jpg"
            alt=""
          />
        </div>
        ...
        <div className="prodcut-of-image-titel-gemstone-product">
          <div className="this-div-of-product-title">
            <span className="titele-of-helf-eternity-diamond-ring">
              {" "}
              Half Eternity Diamond And Pink Sapphire Round Shared Prong Wedding
              Ring (0.57cttw)
            </span>
          ...
          <div className="about-Product-iamge-input-gemstone-ring">
            <div className="div-of-select-group-bands">
              <div className="div-stone-type-new-div">
                ...
                <select className="value-of-sapphire-type">
                  ...
                  <option value="sapphire">Pink Sapphire </option>
                  <option value="sapphire">Ruby </option>
                  <option value="sapphire">Blue Sapphire </option>
                  <option value="sapphire">Emerald </option>
                  <option value="sapphire">Diamond </option>
                </select>
                <i class="fa-solid fa-caret-down" id="careta-reat-down-dit"></i>
              </div>
              <div className="div-stone-type-new-div">
                <span className="stone-type-in-gemstone-bands">
                Total Carat Weight{" "}
                ...
                <select className="value-of-sapphire-type">
                  <option value="sapphire">1.06cts    $1,346</option>
                  <option value="sapphire">1.90cts    $2,621</option>
                  <option value="sapphire">1.90cts    $2,621 </option>
                  <option value="sapphire">3.10cts    $4,586 </option>
                  <option value="sapphire">Pink Sapphire </option>
                </select>
                <i class="fa-solid fa-caret-down" id="careta-reat-down-dit"></i>
              </div>
            ...
            <div className="div-of-select-group-bands">
              <div className="div-stone-type-new-div">
                ...
                <select className="value-of-sapphire-type">
                  <option value="sapphire">Natural Diamonds </option>
                  <option value="sapphire">Lab Diamonds </option>
            ...
            <div className="div-of-select-group-bands">
              <div className="div-stone-type-new-div">
                ...
                <select className="value-of-sapphire-type">
                  <option value="sapphire">14k White Gold </option>
                  <option value="sapphire">14k Yellow Gold </option>
                  <option value="sapphire">14K Rose Gold </option>
                  <option value="sapphire">18k White Gold </option>
                  <option value="sapphire">18k Yellow Gold </option>
                  <option value="sapphire">18K Rose Gold </option>
                  <option value="sapphire">Platinum</option>
                </select>
                <i class="fa-solid fa-caret-down" id="careta-reat-down-dit"></i>
              </div>
              <div className="div-stone-type-new-div">
...
export default Gemstonbandspageofinglepagealld;
