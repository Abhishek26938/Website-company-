...
const EarringGemstoneDetailsBlue = () => {
  return (
    <>
      <div className="Single_product-detail-div-in-info">
        <div className="single-product-div-prodcut-deatails">
          ...
          This simple, yet timeless solitaire design showcases natural Oval Cut blue sapphires held securely in place by four prongs <br /> in your choice of precious metal.
...
export default EarringGemstoneDetailsBlue;
