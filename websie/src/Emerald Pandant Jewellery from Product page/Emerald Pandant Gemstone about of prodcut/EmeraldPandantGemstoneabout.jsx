...
const EmeraldPandantGemstoneabout = () => {
  return (
    <>
      <div className="Single_product-detail-div-in-info">
        <div className="single-product-div-prodcut-deatails">
          ...
          <span className="This-timeless-classic-design-p">
            This simple and elegant design showcases a natural Round Emerald in
            a four prong solitaire setting.
          </span>
        </div>
...
export default EmeraldPandantGemstoneabout;
