...
import './SingleProdcutRing.css'

const SingleProductDetailsFile = () => {
  return (
    <>
      <div className="Single_product-detail-div-in-info">
        <div className="single-product-div-prodcut-deatails">
          <h3>Product Details</h3>
          <span className="This-timeless-classic-design-p">
            This timeless classic design displays a beautiful prong set Round
            blue sapphire crafted by our experts in the heart of the <br />{" "}
            diamond district.
          </span>
        </div>
        <div className="div-detail-in-product-item">
          <div className="item-single-prodcut-ring-detail">
            ...
            <div className="item-single-product-ring-new">
              ...
              <span className="detailbox-info-pro">
                Ring Width (Widest Point): <span style={{color : "black"}}> 2.03mm (Dainty)</span>
              </span>
            </div>
          </div>
          <div className="item-single-prodcut-ring-detail">
            ...
            <div className="item-single-product-ring-new">
              <span className="detailbox-info-pro">
              Type:
 <span style={{color : "black"}}> Natural
Blue Sapphire
Round</span>
              </span>
              <span className="detailbox-info-pro">
              Enhancement:
 <span style={{color : "black"}}>Heated</span>
              </span>
              <span className="detailbox-info-pro">
              Approximate Dimensions:
 <span style={{color : "black"}}>5X5</span>
              </span >
              <span className="detailbox-info-pro">
              Approximate Total Carat Weight:
 <span style={{color : "black"}}>0.65</span>
              </span>
              <span className="detailbox-info-pro">
              Quality Grade:
 ...
 <span style={{color : "black"}}> Prong</span>
              </span>
            </div>
          </div>
        </div>
...
export default SingleProductDetailsFile;
